...
const ConfirmationModal = ({ title, text, confirm, close, closeButtonText }) => {

    /* state and ref */
    const [open, setOpen] = useState(true)
    const cancelButtonRef = useRef(null)

    /* ACTION to disable modal - action coming in as props */
    const handleClose = () => {
        close();
        setOpen(false);
    }

    /* ACTION to instantiate modal - action coming in as props */
    const handleConfirm = () => {
        confirm();
        setOpen(true);
    }
                ...
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                        <div className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            <div className="sm:flex items-center align-center flex content-center">
