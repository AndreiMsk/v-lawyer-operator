    ...
    return (
        <div className="flex justify-start w-full p-6 items-center mt-4 flex-col">
            ...
            <div className="border-b border-gray-200 pb-1 w-full">
                ...
                <p className="mt-1 max-w-2xl text-xs text-gray-500">Your personal information are listed below</p>
            </div>
            ...
            <div className="w-full mt-5 text-sm">
                ...
                <h2 className="mt-3"><span className="text-gray-500">Specialization:</span> Civil Law</h2>
                <h2><span className="text-gray-500">Title</span> Dr. Proffesor Lawyer</h2>
                <h2><span className="text-gray-500">Studies: </span>Harvard University - Law</h2>
